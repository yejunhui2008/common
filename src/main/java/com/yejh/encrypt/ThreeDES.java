...
public class ThreeDES {
	...
	*/
	...
	public static void main(String[] args) {
		...
		byte[] enk = hex("uyunsoft");//用户名  
//		Security.addProvider(new com.sun.crypto.provider.SunJCE());
		String password = "12345678876543211234567887654321";//密码  
		System.out.println("加密前的字符串:" + password);
		byte[] encoded = encryptMode(enk, password.getBytes());
		String pword = parseByte2HexStr(encoded);
		System.out.println("加密后的字符串:" + pword);

		byte[] reqPassword = parseHexStr2Byte(pword);
